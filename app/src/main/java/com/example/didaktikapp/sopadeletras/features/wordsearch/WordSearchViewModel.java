...
import com.example.didaktikapp.sopadeletras.commons.SingleLiveEvent;
...
import com.example.didaktikapp.sopadeletras.data.entity.GameDataMapper;
...
public class WordSearchViewModel extends ViewModel {
    ...
    public WordSearchViewModel(GameDataSource gameDataSource, WordDataSource wordDataSource) {
    ...
    public SingleLiveEvent<AnswerResult> getOnAnswerResult() {
